...
Section "Install"
    ...
    FileWrite $0 "' cmd /C outer-quotes are required when the inner path contains spaces$\r$\n"
    ...
    FileWrite $0 "Else$\r$\n"
    FileWrite $0 "    f.WriteLine $\"OK - node.exe launched (see below for startup output)$\"$\r$\n"
    FileWrite $0 "    f.Close$\r$\n"
